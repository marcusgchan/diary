...
import { useIsMobile } from "@/app/_lib/shared/hooks/use-mobile";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "w-(--sidebar-width) relative z-10 hidden h-svh transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
